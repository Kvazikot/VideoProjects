...
QT_MOC_LITERAL(1, 10, 15), // "ObjectsIsLoaded"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "GlWidget2\0ObjectsIsLoaded\0"
};
...
void GlWidget2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ObjectsIsLoaded(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GlWidget2::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GlWidget2::ObjectsIsLoaded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GlWidget2::ObjectsIsLoaded()
{
