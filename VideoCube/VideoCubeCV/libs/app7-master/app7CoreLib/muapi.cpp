...
//----------------------------------------------------------------------------------
    hStackFile = CreateFileMapping(
                    ...
                    TEXT("Local\\MuapiStack"));                 // name of mapping object
...
//-----------------------------------------------------------------------------------
   hHeapFile = CreateFileMapping(
                 ...
                 TEXT("Local\\MuapiHeap"));                 // name of mapping object
...
//-----------------------------------------------------------------------------------
   ...
   prn("Shared memory stack created in Local\\MuapiStack");
   prn("Shared memory heap created in Local\\MuapiHeap");
